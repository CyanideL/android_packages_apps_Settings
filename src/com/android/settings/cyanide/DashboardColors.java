...
public class DashboardColors extends SettingsPreferenceFragment implements
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.settings_dashboard_colors);
        ...
        intColor = Settings.System.getInt(mResolver,
                Settings.System.SETTINGS_CAT_TEXT_COLOR, BLACK);
        hexColor = String.format("#%08x", (0xffffffff & intColor));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mBgColor) {
            ...
            intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(mResolver,
                    Settings.System.SETTINGS_CAT_TEXT_COLOR, intHex);
            preference.setSummary(hex);
            return true;
        }
        return false;
                    ...
                    .setNeutralButton(R.string.reset_android,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Settings.System.putInt(getOwner().mResolver,
                                    ...
                                    BLACK);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.SETTINGS_CAT_TEXT_COLOR,
                                    WHITE);
