...
public class Armani extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://drive.google.com/folderview?id=0B0BrdNni8k4OVEtucHVrRF9LYTQ&usp=sharing");
            ...
            Uri uri = Uri.parse("http://forum.xda-developers.com/redmi-1s/development/rom-cyanide-l-t3100449");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
