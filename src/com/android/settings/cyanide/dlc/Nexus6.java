...
public class Nexus6 extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=28040");
            ...
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=29011");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        } else if (preference == mXDAThread) {
            Uri uri = Uri.parse("http://forum.xda-developers.com/nexus-6/development/rom-t3082468");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
