...
public class Bacon extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=26597");
            ...
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=26429");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        } else if (preference == mXDAThread) {
            Uri uri = Uri.parse("http://forum.xda-developers.com/oneplus-one/development/cyanidel-t3036665");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
