...
public class Mondrian extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=37184");
            ...
            Uri uri = Uri.parse("http://forum.xda-developers.com/galaxy-tab-pro-12-10-8/development/rom-t3180249");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
