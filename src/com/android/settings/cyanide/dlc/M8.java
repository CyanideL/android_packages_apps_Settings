...
public class M8 extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=23110");
            ...
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=24806");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        } else if (preference == mXDAThread) {
            Uri uri = Uri.parse("http://forum.xda-developers.com/htc-one-m8/development/rom-09-17-t2930743");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
