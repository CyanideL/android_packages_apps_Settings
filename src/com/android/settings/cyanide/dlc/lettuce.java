...
public class lettuce extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=36008");
            ...
            Uri uri = Uri.parse("http://forums.yuplaygod.com/threads/rom-official-5-1-1_r8-cyanidel-lettuce-beast-hell-loads-of-features.18727/");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
