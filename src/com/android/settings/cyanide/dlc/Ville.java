...
public class Ville extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=29023");
            ...
            Uri uri = Uri.parse("http://forum.xda-developers.com/htc-one-s/development/rom-cyanide-l-unofficial-t3075070");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
