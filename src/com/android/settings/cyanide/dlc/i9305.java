...
public class i9305 extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=34695");
            ...
            Uri uri = Uri.parse("http://forum.xda-developers.com/galaxy-s3/development-i9305/rom-cyanide-l-rc-15-0-5-1-1-r5-i9305-7-t3148913");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
