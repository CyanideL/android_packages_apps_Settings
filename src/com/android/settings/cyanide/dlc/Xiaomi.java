...
public class Xiaomi extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://drive.google.com/folderview?id=0B0BrdNni8k4OfnZxWHNrNVRaNWdwWW1hOFpSNklDc3ZrbEVQel9nLW5mQVhtLUpDRXRuWUk&usp=sharing");
            ...
            Uri uri = Uri.parse("http://forum.xda-developers.com/xiaomi-mi-3/development/rom-cyanide-l-rc-12-4-t3113805");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
