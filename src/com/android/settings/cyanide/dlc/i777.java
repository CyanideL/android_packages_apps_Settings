...
public class i777 extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=22055");
            ...
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=22095");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        } else if (preference == mXDAThread) {
            Uri uri = Uri.parse("http://forum.xda-developers.com/galaxy-s2-att/development/cyanogenmod12-rom-unofficial-t2959753");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
