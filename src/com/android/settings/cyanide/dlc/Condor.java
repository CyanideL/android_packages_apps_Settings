...
public class Condor extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://drive.google.com/folderview?id=0B0BrdNni8k4OfnVrTTBTbTZQMEJiOHJfLUN6M194b2gxaGhCSkNXRFZPZVgtYlF4b3pSQkk&usp=sharing");
            ...
            Uri uri = Uri.parse("http://forum.xda-developers.com/moto-e/development/rom-cyanide-l-t3101433");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
