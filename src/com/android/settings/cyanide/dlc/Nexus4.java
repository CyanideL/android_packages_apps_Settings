...
public class Nexus4 extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=35121");
            ...
            Uri uri = Uri.parse("http://forum.xda-developers.com/nexus-4/development/rom-cyanide-l-rc-15-6-5-1-1-r6-mako-7-t3153379/post61772043#post61772043");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
