...
public class tomato extends SettingsPreferenceFragment 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mCyanideOfficial) {
            Uri uri = Uri.parse("https://www.androidfilehost.com/?w=files&flid=35714");
            ...
            Uri uri = Uri.parse("http://forums.yuplaygod.com/threads/rom-official-5-1-1_r8-cyanidel-tomato-beast.18723/");
            Intent intent = new Intent(Intent.ACTION_VIEW, uri);
            startActivity(intent);
            return true;
        }
