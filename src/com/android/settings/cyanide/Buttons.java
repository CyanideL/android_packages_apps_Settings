        ...
        if (hasBackKey) {
            ...
            if (settings != null) {
                ...
                int doubleTapAction = Settings.System.getInt(resolver,
                        ...
                        KEY_ACTION_NOTHING);
                settings.mBackDoubleTapAction = settings.initActionList(
                        KEY_BACK_DOUBLE_TAP, doubleTapAction);
            }
        } else {
        ...
        if (hasMenuKey) {
            ...
            if (settings != null) {
                ...
                int doubleTapAction = Settings.System.getInt(resolver,
                        ...
                        KEY_ACTION_NOTHING);
                settings.mMenuDoubleTapAction = settings.initActionList(
                        KEY_MENU_DOUBLE_TAP, doubleTapAction);
            }
        } else {
        ...
        if (hasAssistKey) {
            ...
            if (settings != null) {
                ...
                int doubleTapAction = Settings.System.getInt(resolver,
                        ...
                        KEY_ACTION_NOTHING);
                settings.mAssistDoubleTapAction = settings.initActionList(
                        KEY_MENU_DOUBLE_TAP, doubleTapAction);
            }
        } else {
        ...
        if (hasAppSwitchKey) {
            ...
            if (settings != null) {
                ...
                int doubleTapAction = Settings.System.getInt(resolver,
                        ...
                        KEY_ACTION_NOTHING);
                settings.mAppSwitchDoubleTapAction = settings.initActionList(
                        KEY_APP_SWITCH_DOUBLE_TAP, doubleTapAction);
