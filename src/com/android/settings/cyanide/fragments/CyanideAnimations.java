...
import com.android.settings.cyanide.AnimationControls;
import com.android.settings.cyanide.KeyboardAnimationInterfaceSettings;
import com.android.settings.cyanide.ScrollAnimationInterfaceSettings;
import com.android.settings.cyanide.OverscrollEffects;
...
public class CyanideAnimations extends SettingsPreferenceFragment {
    ...
    class StatusBarAdapter extends FragmentPagerAdapter {
        ...
        public StatusBarAdapter(FragmentManager fm) {
            ...
            frags[1] = new KeyboardAnimationInterfaceSettings();
            frags[2] = new ScrollAnimationInterfaceSettings();
            frags[3] = new OverscrollEffects();
            //frags[4] = new ProgressBar();
            frags[4] = new MoreAnimations();
        }
    ...
    private String[] getTitles() {
        ...
        titleString = new String[]{
                    getString(R.string.system_animations_cat_title),
                    getString(R.string.keyboard_animations_cat_title),
                    getString(R.string.scroll_animations_cat_title),
                    getString(R.string.overscroll_effects_cat_title),
                    //getString(R.string.progress_bar_cat_title),
                    getString(R.string.more_animations_cat_title)};
        } else {
        titleString = new String[]{
                    getString(R.string.system_animations_cat_title),
                    getString(R.string.keyboard_animations_cat_title),
